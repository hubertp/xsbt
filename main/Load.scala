...
object Load
{
	...
	def initialSession(structure: BuildStructure, rootEval: () => Eval): SessionSettingsStub =
		new SessionSettingsStub(structure.root, rootProjectMap(structure.units), structure.settings, Map.empty, rootEval)
